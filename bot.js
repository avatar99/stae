...
client.on('message', msg => {  //WESO#0001
    if (msg.content === 'انا؟') {  //WESO#0001
      msg.reply('**لا سيدي**');  //WESO#0001
    }
  });


client.on('message', msg => {  //WESO#0001
    if (msg.content === 'كلزق') {  //WESO#0001
      msg.reply('**شبعان ولله**');  //WESO#0001
    }
  });
...
client.login("NTk4NTc0MjcyMTU5NDE2MzIx.XSYn-A.BpLj1gH8YLSHAb-hICzuNm_PSik");
